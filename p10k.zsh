# Generated by Powerlevel10k configuration wizard on 2020-04-06 at 06:44 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # virtualenv              # python virtual environment (https://docs.python.org/3/library/venv.html) Mutually exclusive with pyenv 
